...
class ChatPageCurie extends StatefulWidget{
  const ChatPageCurie({super.key});

  @override
  State<ChatPageCurie> createState() => _ChatPageState();
}
...
class _ChatPageState extends State<ChatPageCurie>{
