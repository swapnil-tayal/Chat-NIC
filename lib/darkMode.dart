...
import 'package:chatnic/ChatPageCurieDark.dart';
...
class ChatPageDark extends StatefulWidget{
  const ChatPageDark({super.key});

  @override
  State<ChatPageDark> createState() => _ChatPageState();
}
...
class _ChatPageState extends State<ChatPageDark>{
                  ...
                  Navigator.of(context).push(
                      MaterialPageRoute(
                          builder: (BuildContext context){
                            return const ChatPageCurieDark();
                          }
                      )
                  );
                },
